...
IoMod::IoMod() : 
  init(TTF_Init()),
  renderer( RenderContext::getInstance().getRenderer() ),//change gof singleton to meyers
...
//Item 5: overload IoMod::writeText
void IoMod::writeText(const std::string& msg, int x, int y, SDL_Color const color) const{
  SDL_Surface *surface =
